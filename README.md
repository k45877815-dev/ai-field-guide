...
5. Wait 1–2 minutes, then your site is live at:
   `https://YOUR-USERNAME.github.io/ai-field-guide/`

## 2. Replace the placeholder URL everywhere

Every file has `https://YOUR-USERNAME.github.io/ai-field-guide/` in a few meta tags (canonical links, Open Graph tags) and in `sitemap.xml` / `robots.txt`. Find-and-replace `YOUR-USERNAME` with your actual GitHub username in every `.html` file plus `sitemap.xml` and `robots.txt`. This matters — search engines use these tags, and wrong ones can quietly hurt indexing.
...
2. Add your site as a URL-prefix property: `https://YOUR-USERNAME.github.io/ai-field-guide/`
...
4. Update every `YOUR-USERNAME.github.io/ai-field-guide/` reference in the HTML/sitemap/robots files to your new domain instead.
